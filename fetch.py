#!/usr/bin/env python3
"""
Recuperation des codes promo Photobox depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/photobox.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/photobox.fr"
STORE_NAME = "Photobox"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Photobox depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-photobox)"
    }
    try:
